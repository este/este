...
// This file is written as plain JS because it's required by the server.
...
const mappers = {
  '/edit': {
    req: match('/edit/:webName'),
    link: ({ pathname, query: { webDomain, ...query } }) => ({
      pathname: `${pathname}/${webDomain}`,
      query,
    }),
  },
};
